...
const animes: Anime[] = [
  {
    ...
    src: logoBg,
    translate: 'translate(0px, -620px)',
  },
  {
    className: 'logo-anime-2',
    src: logoBg2,
    translate: 'translate(0px, -410px)',
  },
  {
    ...
    <div className="logo-svg">
      ...
      >
        <defs>
          <mask id="logomask">
            <g fill="#fff">
              <rect x="255.5" width="92.9" height="92.9" />
              <path
        ...
        <g className="real" style={{ opacity: small ? 1 : 0 }}>
          <rect x="255.5" width="92.9" height="92.9" fill="#A8D5FF" />
          <path
            fill="#A8D5FF"
            d="M263.5,212L100.8,0H0v349h92.9V147.4l109.2,140.3c51.4,65.7,146.3,61.3,146.3,61.3v-94.9c-47.4-0.5-85-42-85-42
          L263.5,212z"
...
const WrappedLogoSVG: React.FC<LogoSVGProps> = ({ small }) => {
